  ...
  return (
    <div ref={containerRef} className="min-h-screen bg-white">
      ...
      <section className="relative bg-gradient-brand text-white overflow-hidden">
        ...
        {/* Full-height guy image positioned absolutely on right */}
        <div className="hidden lg:block absolute right-0 bottom-0 h-full z-10" style={{ width: "42%" }}>
          <img
          ...
          <div className="floating-badge top-[18%] left-4 flex items-center gap-2">
          ...
          <div className="floating-badge top-[10%] right-4 flex items-center gap-2" style={{ animationDelay: "0.5s" }}>
          ...
          <div className="floating-badge bottom-[20%] right-4 flex items-center gap-2" style={{ animationDelay: "1s" }}>
            <div className="w-10 h-10 bg-primary rounded-xl flex items-center justify-center flex-shrink-0">
              <svg className="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="relative max-w-[1140px] mx-auto px-4 sm:px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-14 items-center min-h-[500px] lg:min-h-[700px]">
            ...
            {/* Right: Empty spacer - image is positioned absolutely */}
