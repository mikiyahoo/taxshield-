    ...
    <div ref={containerRef} className="min-h-screen bg-white">
      ...
      <section className="py-16 md:py-24 bg-bg-light">
        <div className="max-w-[1140px] mx-auto px-4 sm:px-6">
          ...
          <div className="mb-8">
            {/* 
              ELFSIGHT WIDGET SETUP:
              1. Sign up at https://elfsight.com (free tier available)
              2. Create a Google Reviews widget
              3. Connect your Google Business Profile
              4. Copy the widget ID (looks like: elfsight-app-XXXX-XXXX)
              5. Replace the placeholder below with your actual widget ID
            */}
            <div 
              className="elfsight-app-75a8c66e-3c9c-4a18-9e0c-1f9c6e7a8b4d" 
