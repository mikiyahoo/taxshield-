...
export default function MetaAdsLandingPage() {
  ...
  return (
    <div ref={containerRef} className="min-h-screen bg-white">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-14 items-center min-h-[500px] lg:min-h-[700px]">
            ...
            <div className="relative animate-slide-right hidden lg:flex justify-end items-end self-end -mb-1">
              <div className="relative w-full max-w-xl">
                ...
                {/* Floating Badge 2: $7,000 Advance - top right */}
                <div className="floating-badge -top-4 -right-8 flex items-center gap-2" style={{ animationDelay: "0.5s" }}>
                ...
                {/* Floating Badge 3: No Fees - bottom right */}
                <div className="floating-badge -bottom-4 -right-8 flex items-center gap-2" style={{ animationDelay: "1s" }}>
                  <div className="w-10 h-10 bg-primary rounded-xl flex items-center justify-center flex-shrink-0">
                    <svg className="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      {/* ===== SECTION 4: OFFER ===== */}
      <section className="py-12 md:py-16 bg-gradient-brand text-white">
        <div className="max-w-[1140px] mx-auto px-4 sm:px-6">
          <div className="max-w-2xl mx-auto text-center reveal">
            <h2 className="text-3xl md:text-4xl font-extrabold mb-6">
              Get Up to $7,000 — Fast
            </h2>
